      ...
      <View className="h-[180px] w-[90%] bg-white rounded-2xl mt-5">
        ...
        >
          <View className="flex-row justify-between px-4 pt-3">
            <Text
              className="text-[22px] font-semibold text-black rounded-xl p-2 bg-white"
          ...
          <View className="flex-row items-center px-4 py-3">
            ...
            <Text
              className="text-black text-[20px] font-medium rounded-lg p-1 bg-white"
              style={{ fontFamily: "poppins-medium" }}
            >
              @{username}
            </Text>
          ...
          <View className="px-4 bg-white rounded-md  py-3">
            <Text
              className="text-[#767676] text-[16px] font-normal"
              style={{ fontFamily: "poppins-medium" }}
            >
    ...
    <View>
        ...
        <View className="mx-7">
          <View className="flex-row justify-between mt-6">
            ...
            <Icon
              ...
              color="#000"
              onPress={() => {
                navigation.navigate("HintComunity");
              }}
            />
          </View>
          <SearchBar
      ...
      >
        {categories.map((category, index) => (
          <TouchableOpacity
            key={index}
            className={`bg-white h-16 p-4 mx-3 rounded-xl shadow flex-row items-center justify-between ${
              selectedCategories.includes(category.label) ? "bg-[#78CAD2]" : ""
            }`}
            onPress={() => {
      ...
      {cards ? (
        ...
        <>
          <View className="items-center justify-center flex">
            <Text
              className="text-base mt-32 text-[#4A4A4A]"
              style={{ fontFamily: "poppins-medium", opacity: 0.6 }}
            >
              Nenhum Resultado
            </Text>
