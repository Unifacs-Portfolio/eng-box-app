...
const HintComunity = () => {
  ...
  return (
    <SafeAreaView className="bg-[#F8F8F8] h-full mt-5">
      <TouchableWithoutFeedback onPress={togglePress}>
        <View className="absolute bottom-10 right-8 bg-[#4A4A4A] rounded-full w-14 h-14 flex items-center justify-center shadow-lg z-10">
          <Icon
